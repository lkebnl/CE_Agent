#!/bin/bash
# FEMB QC SSH 命令序列
# 生成时间  : 2026-04-06 12:19:16
# WIB 地址  : root@192.168.121.123
# 基线电压  : 200mV
# 增益      : 14mV/fC
# 成形时间  : 2us
# 输出文件  : RMS_SE_200mVBL_14_0mVfC_2_0us_0x00.bin
# 本地目录  : ./data/20260406_121916
# ──────────────────────────────────────────────────────────

# ── Section 0: WIB 初始化 (time sync + startup) ──────────────
ssh root@192.168.121.123 "date -s '2026-04-06 16:19:16'"  # timeout=15s
...
ssh root@192.168.121.123 "cd /home/root/BNL_CE_WIB_SW_QC; PYTHONPATH=/home/root/BNL_CE_WIB_SW_QC python3 /home/root/BNL_CE_WIB_SW_QC/atoms/wib_acquire.py 3 --samples 5 --output RMS_SE_200mVBL_14_0mVfC_2_0us_0x00.bin"  # timeout=120s

# ── Section 3: 拉取数据到本地 ───────────────────────────────────
scp -r root@192.168.121.123:/home/root/BNL_CE_WIB_SW_QC/QC/ ./data/20260406_121916
