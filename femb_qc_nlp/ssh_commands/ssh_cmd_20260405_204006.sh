#!/bin/bash
# FEMB QC SSH 命令序列
# 生成时间  : 2026-04-05 20:40:06
# WIB 地址  : root@192.168.121.123
# 基线电压  : 200mV
# 增益      : 14mV/fC
# 成形时间  : 2us
# 输出文件  : RMS_SE_200mVBL_14_0mVfC_2_0us_0x00.bin
# 本地目录  : ./data/20260405_203850
# ──────────────────────────────────────────────────────────

# ── Section 0: WIB 初始化 (time sync + startup) ──────────────
ssh root@192.168.121.123 "date -s '2026-04-06 00:40:06'"  # timeout=15s
...
# ── Section 3: 拉取数据到本地 ───────────────────────────────────
scp -r root@192.168.121.123:/home/root/BNL_CE_WIB_SW_QC/QC/ ./data/20260405_203850
